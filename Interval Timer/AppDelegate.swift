...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        UITabBar.appearance().selectionIndicatorImage = UIImage(named: "Копия tabSelectBG")
        ...
        if let barFont = UIFont(name: "AppleSDGothicNeo-Light", size: 22) {
            // текст должен быть белым и его шрифт текста должен быть barFont в том случае если такой шрифт существует
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "Interval_Timer")
